...
import { BlueSignal, CalenderIcon, Delete, Edit, SearchIcon, View } from "../../../icons";
...
import { AddEditBranchCapital } from "./AddEditBranchCapital";


export const BranchCapitalList = () => {

      


const branchCapitalData = [
  {
    date: "2024-06-20",
  ...
  const [isShowing, setIsShowing] = useState(false);
    ...
    const [isAddEditBranchCapitalDialogOpen, setIsAddEditBranchCapitalDialogOpen] = useState(false)
      ...
      <div className="border rounded-lg">
        <div className="flex flex-row gap-2 items-center bg-[#F4F6F8] p-4 rounded-md py-4">
          ...
          <span className="font-semibold text-[18px] leading-8">
            {t("BRANCH_CAPITAL.BRANCH_CAPITAL")}
          </span>
        </div>
        ...
        <div className="bg-white col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-2">
          ...
          <div className="col-span-12 md:col-span-3">
            <div className="relative">
              <FloatingDropdown label={t('BRANCH_CAPITAL.TRANSACTION_TYPE')} options={[{value:"1",label:'Type 1'}]} />
            </div>
          </div>
          ...
          <div className="col-span-12 md:col-span-3">
            <div className="relative">
              <FloatingInput label={t('BRANCH_CAPITAL.DATE')}  rightIcon={<CalenderIcon/>}/>
            </div>
          </div>
