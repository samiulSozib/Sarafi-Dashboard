...
export const AddEditOtherItems = ({ isOpen, onClose, isEditing, isShowing }) => {
      ...
      {setShowForm && (
        <div className="bg-white rounded-xl p-8 w-full max-w-5xl max-h-[90vh] overflow-y-auto flex flex-col">
          ...
          <div className="col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-2">
           ...
           {/* AMOUNT */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput label={t('OTHER_ITEMS.AMOUNT')} />
            </div>
            ...
            <div className="col-span-12 md:col-span-12 relative">
              <FloatingTextarea label={t('OTHER_ITEMS.DETAILS')} />
            </div>
