...
export const AddEditBankCapital = ({ isOpen, onClose, isEditing, isShowing }) => {
      ...
      {setShowForm && (
        <div className="bg-white rounded-xl p-8 w-full max-w-5xl max-h-[90vh] overflow-y-auto flex flex-col">
          ...
          <div className="col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-2">
           ...
           {/* ACCOUNT */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput label={t('BANK_CAPITAL.ACCOUNT')} />
            </div>
            
            {/* BRANCH */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingDropdown
                label={t("BANK_CAPITAL.BRANCH")}
                options={[
                  { value: "1", label: "Type 1" },
                  { value: "1", label: "Type 1" },
                ]}
             ...
             {/* AMOUNT */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput label={t('BANK_CAPITAL.AMOUNT')} />
            </div>

            {/* CURRENCY */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingDropdown
                label={t("BANK_CAPITAL.CURRENCY")}
                options={[
                  { value: "1", label: "Type 1" },
                  { value: "1", label: "Type 1" },
                ]}
