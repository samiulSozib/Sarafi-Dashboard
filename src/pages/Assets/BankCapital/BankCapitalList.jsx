...
import { AddEditBankCapital } from "./AddEditBankCapital";


export const BankCapitalList = () => {
  ...
  return (
    <div className='overflow-hidden pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6"'>
      <div className="flex flex-row justify-end mb-3">
        ...
        >
          {t("BANK_CAPITAL.ADD_BANK_CAPITAL")}
        </Button>
      </div>
      ...
      <div className="border rounded-lg">
        ...
        <div className="bg-white col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-2">
          ...
          <div className="col-span-12 md:col-span-2">
            <div className="relative">
              <FloatingDropdown label={t('BANK_CAPITAL.BANK')} options={[{value:"1",label:'Type 1'}]} />
            </div>
          </div>

          <div className="col-span-12 md:col-span-2">
            <div className="relative">
              <FloatingDropdown label={t('BANK_CAPITAL.BRANCH')} options={[{value:"1",label:'Type 1'}]} />
            </div>
          </div>

          <div className="col-span-12 md:col-span-2">
            <div className="relative">
              <FloatingInput label={t('BANK_CAPITAL.DATE')}  rightIcon={<CalenderIcon/>}/>
            </div>
          </div>
