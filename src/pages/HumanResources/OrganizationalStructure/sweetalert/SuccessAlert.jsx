...
const SuccessAlert = ({ onClose,personalNumber }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-2xl p-6 w-[70%] max-w-[350px] text-center shadow-lg">
        ...
        <div className="p-3">
          ...
          {/* Account Number */}
          <div className="text-gray-700 mb-4 flex flex-row justify-between">
            <span className="ml-2 text-gray-500">{t('COMMON.PERSONAL_NUMBER')}</span>
        ...
        <div className="flex justify-center mb-6">
          <img
            src="/images/sarafi/success_icon.png"
            alt="Success"
