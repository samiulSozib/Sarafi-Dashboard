...
export const AddEditShareHolder = ({
  isOpen,
  onClose,
  isEditing,
  isShowing,
        ...
        <div className="bg-white rounded-xl p-8 w-full max-w-5xl max-h-[90vh] overflow-y-auto flex flex-col">
          ...
          <div className="col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-2">
            ...
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput label={t("SHAREHOLDERS.FULL_NAME")} />
            </div>

            {/* FATHER NAME */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput label={t("SHAREHOLDERS.FATHER_NAME")} />
            </div>

            {/* DATE OF EMPLOYMENT */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput label={t("SHAREHOLDERS.RATE")} />
            </div>

            {/* identity document type */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingDropdown
                label={t("SHAREHOLDERS.ID_TYPE")}
                options={[
            ...
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput label={t("SHAREHOLDERS.ID_NUMBER")} />
            </div>
            {/* identity document type */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingDropdown
                label={t("SHAREHOLDERS.COUNTRY_RESIDENCE")}
                options={[
                  { value: "1", label: "Type 1" },
                  { value: "1", label: "Type 1" },
                ]}
            ...
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingDropdown
                label={t("SHAREHOLDERS.COUNTRY_OF_BIRTH")}
                options={[
                  { value: "1", label: "Type 1" },
                  { value: "1", label: "Type 1" },
                ]}
            ...
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput
                label={t("SHAREHOLDERS.DATE_OF_BIRTH")}
            ...
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput
                label={t("SHAREHOLDERS.DATE_OF_MEMBERSHIP")}
                rightIcon={<CalenderIcon />}
              />
            </div>
            ...
            {/* phone number */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput label={t("SHAREHOLDERS.PHONE_NUMBER")} />
            </div>
            {/* phone number */}
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput label={t("SHAREHOLDERS.EMAIL")} />
            </div>
            {/* address  */}
            <div className="col-span-12 md:col-span-4 relative">
              <textarea
