...
export const AddEditBranch = ({ isOpen, onClose, isEditing, isShowing }) => {
      ...
      {setShowForm && (
        <div className="bg-white rounded-xl p-8 w-full max-w-5xl max-h-[90vh] overflow-y-auto flex flex-col">
          ...
          <div className="col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-2">
            ...
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput
                label={t("BRANCH.BRANCH_NAME_ENGLISH")}
            ...
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput
                label={t("BRANCH.BRANCH_NAME_DARI")}
            ...
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput
                label={t("BRANCH.BRANCH_MANAGER_NAME")}
            ...
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput
                label={t("BRANCH.ADDRESS_OPTIONAL")}
