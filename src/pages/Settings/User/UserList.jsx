  ...
  const userList = [
    {
      profileName: "name1",
      userName: "username",
      permittedTransferAmount: 100,
      currency: "AFN",
      branch: "branch",
      email: "samiulcse2018@gamil.com",
      row: 1,
    },
    {
      profileName: "name1",
            ...
            <TableHeader className="bg-[#F4F6F8] border-b border-gray-100 dark:border-white/[0.05]">
              <TableRow>
                ...
                <TableCell
                  ...
                  className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"
                >
                  {t("USER.PERMITTED_TRANSACTION_AMOUNT")}
                </TableCell>
                <TableCell
                  isHeader
                  className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400"
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {userList.map((record) => (
                <TableRow key={record.id}>
                  ...
                  <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                    {record.permittedTransferAmount}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                    {record.currency}
                  </TableCell>
