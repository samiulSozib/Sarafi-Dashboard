...
import { AddEditSystemAccount } from "./AddEditSystemAccount";

export const SystemAccountList = () => {
      ...
      <div className="border rounded-lg">
        <div className="flex flex-row gap-2 items-center bg-[#F4F6F8] p-4 rounded-md py-4">
          ...
          <span className="font-semibold text-[18px] leading-8">
            {t("SYSTEM_ACCOUNT.SETTINGS_SYSTEM_ACCOUNT")}
          </span>
        </div>
        ...
        <div className="bg-white col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-2">
          ...
          <div className="col-span-12 md:col-span-4">
            <div className="relative">
              <FloatingInput
                label={t("SYSTEM_ACCOUNT.ACCOUNT_NUMBER")}
                rightIcon={<Search />}
              />
            </div>
          </div>
