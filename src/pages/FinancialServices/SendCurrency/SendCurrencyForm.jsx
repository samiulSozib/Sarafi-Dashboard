    ...
    <div className='overflow-hidden border rounded-md p-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6"'>
      ...
      <div>
        <div className="mt-6 mb-6">
          <span className="font-semibold">
            {t("SEND_CURRENCY.SENDER_INFORMATION")}
          </span>
        </div>
      ...
      <div>
        <div className="mt-6 mb-6 flex flex-col md:flex-row justify-between">
          ...
          <span className="font-semibold">
            {t("SEND_CURRENCY.RECIPIENT_INFORMATION")}
          </span>
          <FloatingDropdown className="w-full md:w-[300px] mt-5 md:mt-0" options={[{value:'1',label:'Type 1'}]} label={t('SEND_CURRENCY.AGENCY_FOR_RECEIVING_FOREIGN_CURRENCY')} />
        </div>
          ...
          <div className="grid grid-cols-12 gap-3 md:gap-6">
            <div className="col-span-12 md:col-span-6 w-full">
              <FloatingSelect
                ...
                label={t("SEND_CURRENCY.CURRENCY_DEPOSIT")}
              />
            </div>
            <div className="col-span-12 md:col-span-6 w-full">
              <FloatingInput
                label={t("SEND_CURRENCY.DEPOSIT_AMOUNT")}
                rightIcon={
                  <img
            ...
            <div className="col-span-12 md:col-span-6 w-full">
              <FloatingSelect
                options={[{ value: "1", label: "Type 1" }]}
                label={t("SEND_CURRENCY.CURRENCY_RECEIVE")}
              />
            </div>
            <div className="col-span-12 md:col-span-6 w-full">
              <FloatingInput
                label={t("SEND_CURRENCY.AMOUNT_RECEIVE")}
                rightIcon={
                  <img
                    src="/images/country/country-01.svg"
                    className="h-5 w-5"
        ...
        <div className="col-span-12 md:col-span-4 flex flex-col bg-[#F2FAFF] p-5 rounded-md">
          <div className="flex flex-row justify-between">
            <span className="text-[14px] font-semibold text-gray-400">
              {t("SEND_CURRENCY.REAL_TIME_USD_RATE")}
            </span>
            <img
              src="/images/country/country-01.svg"
              alt=""
      ...
      <div>
        <div className="mt-6 mb-6">
          <span className="font-semibold">
            {t("SEND_CURRENCY.COMMISSION_PAYMENT")}
          </span>
        </div>
        <div className="bg-white col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-3 mt-3">
          <div className="flex flex-row gap-3 col-span-12 md:col-span-6 relative">
            ...
            >
              <Radio
                ...
                checked={recipientCustomerType === "temporary"}
                onChange={setRecipientCustomerType}
                label={t("SEND_CURRENCY.ONE_WAY", { text: "(3%)" })}
              />
            </div>
            ...
            >
              <Radio
                ...
                checked={recipientCustomerType === "permanent"}
                onChange={setRecipientCustomerType}
                label={t("SEND_CURRENCY.TWO_WAY", { text: "(10%)" })}
              />
            </div>
          </div>
          ...
          <div className="col-span-12 md:col-span-6 relative">
            <FloatingInput
              className="bg-[#F2FAFF]"
              label={t("SEND_CURRENCY.COMMISSION_AMOUNT")}
      ...
      <div className="mt-5 mb-5 flex flex-row justify-between p-3">
        <span className="text-[16px] font-semibold text-gray-600">{t('SEND_CURRENCY.TOTAL_PAYMENT')}</span>
      ...
      {showSuccess && (
        <SuccessAlert
          onClose={() => {
            ...
            navigate("/financial-services/send-currency");
          }}
        />
      )}
    </div>
