...
export const DepositToBankForm = () => {
    ...
    <div className='overflow-hidden border rounded-md p-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6"'>
      <div className="border rounded-lg">
        <div className="flex flex-row gap-2 items-center bg-[#F4F6F8] p-4 rounded-md py-2">
          ...
          <span className="font-semibold text-[18px] leading-8">
            {t("DEPOSIT_TO_BANK.CASH_DEPOSIT_TO_BANK_ACCOUNT")}
          </span>
        </div>
      </div>
      ...
      <div>
        <div className="mt-6 mb-6 flex flex-col md:flex-row justify-between">
          <span className="font-semibold">
            {t("DEPOSIT_TO_BANK.ACCOUNT_HOLDER_INFORMATION")}
          </span>
        </div>
        ...
        <div className="bg-white col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-3 mt-3">
          <>
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingDropdown
                label={t("DEPOSIT_TO_BANK.CUSTOMER_NAME")}
                isRTL={isRTL}
                options={[
                  { value: "1", label: "Option 1" },
                  { value: "1", label: "Option 3" },
            ...
            <div className="col-span-12 md:col-span-4 relative">
              <FloatingInput
                label={t("DEPOSIT_TO_BANK.ACCOUNT_NUMBER")}
                isRTL={isRTL}
              />
            </div>
            <div className="col-span-12 md:col-span-4 relative">
      ...
      <div className="bg-white col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-3 mt-3">
        <>
          <div className="col-span-12 md:col-span-4 relative">
            <FloatingDropdown
              label={t("DEPOSIT_TO_BANK.DEPOSIT_CURRENCY")}
              isRTL={isRTL}
              options={[
                { value: "1", label: "Option 1" },
                { value: "1", label: "Option 3" },
          ...
          <div className="col-span-12 md:col-span-4 relative">
            <FloatingInput
              label={t("DEPOSIT_TO_BANK.DEPOSIT_AMOUNT")}
              isRTL={isRTL}
      ...
      {showSuccess && (
        <SuccessAlert
          onClose={() => {
            ...
            navigate("/financial-services/deposit-to-bank");
          }}
        />
      )}
    </div>
