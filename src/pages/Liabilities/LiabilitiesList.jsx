...
import { AddEditLiabilities } from "./AddEditLiabilities";
  ...
  const liabilitiesData = [
    {
      status: "Pending",
      date: "2025-06-20",
      description: "Awaiting approval for payment",
      currency: "USD",
      amount: 1500.0,
      debtType: "Asset",
    ...
    },
    {
      status: "Not Approved",
      date: "2025-06-17",
      description: "Deferred payment contract",
      currency: "AFN",
      amount: 9500,
      debtType: "Asset",
      category: "Postpayment Contract",
      row: 3,
    },
  ];
  ...
  return (
    <div className='overflow-hidden pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6"'>
      <div className="flex flex-row justify-end mb-3">
        ...
        >
          {t("LIABILITIES.ADD_NEW_DOCUMENT")}
        </Button>
      </div>
      ...
      <div className="border rounded-lg">
        <div className="flex flex-row gap-2 items-center bg-[#F4F6F8] p-4 rounded-md py-4">
          ...
          <span className="font-semibold text-[18px] leading-8">
            {t("LIABILITIES.LIABILITIES_AND_PAYMENTS")}
          </span>
        </div>
        ...
        <div className="bg-white col-span-12 grid grid-cols-12 gap-3 md:gap-6 p-2 mb-2">
          ...
          <div className="col-span-12 md:col-span-3">
            <div className="relative">
              <FloatingDropdown
                label={t("LIABILITIES.ASSET_TYPE")}
                options={[{ value: "1", label: "Type 1" }]}
              />
            </div>
          </div>
          ...
          <div className="col-span-12 md:col-span-3">
            <div className="relative">
              <FloatingDropdown
                label={t("LIABILITIES.PAYMENT_METHOD")}
                options={[{ value: "1", label: "Type 1" }]}
              />
            </div>
          </div>
